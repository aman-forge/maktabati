    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
      <div className="container mx-auto flex h-16 items-center justify-between gap-4 px-4 lg:px-6">
          ...
          <NavigationMenu className="hidden md:flex">
            <NavigationMenuList className="gap-1">
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <div className="grid w-[600px] grid-cols-[0.8fr_1.2fr] gap-0">
                    {/* Featured: My Library */}
                    <div className="p-2">
                      <NavigationMenuLink asChild>
                        <Link
                  ...
                  <div className="w-[300px]">
                    ...
                    <div className="mt-2 border-t pt-2">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          <div className="flex size-10 items-center justify-center rounded-lg bg-linear-to-br from-amber-500 to-orange-500 shadow-sm">
        ...
        <div className="flex items-center gap-1">
          <Button
            variant="outline"
            className="hidden h-9 gap-2 px-3 text-muted-foreground lg:flex"
          >
            <Search className="size-4" />
            <span className="text-sm">بحث...</span>
            <kbd className="pointer-events-none mr-4 hidden h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium opacity-100 xl:flex">
