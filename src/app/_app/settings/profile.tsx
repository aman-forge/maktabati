			...
			>
				<div className="flex items-center gap-6">
					<div className="relative">
						...
						<button
							type="button"
							className="absolute bottom-0 left-0 flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-105"
						>
