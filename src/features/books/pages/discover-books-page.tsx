...
import type { BookSearch } from "@/features/books/lib/validators";
...
const routeApi = getRouteApi("/_public/discover/books");
...
export function BooksSearchPageSkeleton() {
  return (
...
export function BooksSearchPage() {
  const { result: loaderData, publisherOptions } = routeApi.useLoaderData();
  const search = routeApi.useSearch();
  const navigate = useNavigate({ from: "/discover/books" });
