...
import type { BookCardType, AuthorSummary } from "@/features/books/types";
import { cn } from "@/ui/lib/utils";

type FlexibleBook = Omit<BookCardType, "author" | "total"> & {
...
export function BookCard({ book, author = false, size = "md" }: BookCardProps) {
