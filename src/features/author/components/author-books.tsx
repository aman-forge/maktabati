...
const MOCK_ALL_BOOKS = [
  { id: "1", title: "الثلاثية", year: "١٩٥٦", rating: "٤٫٨", type: "series", coverColor: "#EDE9FE", barColor: "#7C3AED" },
  { id: "2", title: "أولاد حارتنا", year: "١٩٥٩", rating: "٤٫٥", type: "novel", coverColor: "#D1FAE5", barColor: "#059669" },
  { id: "3", title: "زقاق المدق", year: "١٩٤٧", rating: "٤٫٦", type: "novel", coverColor: "#FEF3C7", barColor: "#D97706" },
  { id: "4", title: "الحرافيش", year: "١٩٧٧", rating: "٤٫٧", type: "novel", coverColor: "#FFE4E6", barColor: "#E11D48" },
  { id: "5", title: "خان الخليلي", year: "١٩٤٥", rating: "٤٫٣", type: "novel", coverColor: "#EFF6FF", barColor: "#2563EB" },
  { id: "6", title: "اللص والكلاب", year: "١٩٦١", rating: "٤٫٤", type: "novel", coverColor: "#F0FDF4", barColor: "#16A34A" },
  { id: "7", title: "دنيا الله", year: "١٩٦٣", rating: "٤٫١", type: "story", coverColor: "#FFF7ED", barColor: "#EA580C" },
  ...
  return (
    <div dir="rtl">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 gap-4">
        {filtered.map((book) => (
          <Link key={book.id} to="/book/$id" params={{ id: book.id }} className="group flex flex-col gap-1.5">
            <div
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 h-1" style={{ background: book.barColor }} />
            </div>
